...
class tlcog:
    ...
    def cutify_worker(self, m:str):
        m = m.replace('@', '').replace('R', 'w').replace('r', 'w').replace('Na', 'Nya').replace('na', 'nya').replace('Ne', 'Nye').replace('ne', 'nye').replace('Ni', 'Nyi').replace('ni', 'nyi').replace('No', 'Nyo').replace('no', 'nyo').replace('Nu', 'Nyu').replace('nu', 'nyu')
        return m
